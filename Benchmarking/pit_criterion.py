...
def cal_loss_NoPerms(source, estimate_source, source_lengths):
    """
    Args:
        ...
        source_lengths: [B]
    """
    max_snr = cal_si_snr_with_nopit(source,
                                                      estimate_source,
                                                      source_lengths)
...
def cal_si_snr_with_nopit(source, estimate_source, source_lengths):
    ...
    max_snr /= C
    """
    return pair_wise_si_snr #max_snr, perms, max_snr_idx
